  ...
  return (
    <div className="p-8 transition-all duration-300">
      ...
      <div className="mb-8" data-content="Main Steps in Conducting an RLA">
        ...
        <ol className="list-decimal ml-6 text-gray-700 dark:text-white text-lg space-y-4">
          <li>
      ...
      >
        ...
        <ul className="list-disc ml-6 text-gray-700 dark:text-white text-lg space-y-2">
          <li>
